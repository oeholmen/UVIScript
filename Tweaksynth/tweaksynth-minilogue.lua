...
function controllerValueToWidgetValue(value, bipolar)
  local factor = 127
  if bipolar == 1 then
    factor = factor / 2
  end
  print("Value in/out/factor", value, (value / factor) - bipolar, factor)
  return (value / factor) - bipolar
end
...
function onController(e)
  local controllerToWidgetMap = {
    CC24 = {name = "LfoFreq", bipolar = 0},
    CC26 = {name = "LfoToCutoff", bipolar = 1},
    CC29 = {name = "HpfCutoff", bipolar = 0},
    CC30 = {name = "HpfResonance", bipolar = 0},
    CC31 = {name = "HpfEnvelopeAmt", bipolar = 1},
    CC43 = {name = "Cutoff", bipolar = 0},
    CC44 = {name = "Resonance", bipolar = 0},
    CC45 = {name = "EnvelopeAmt", bipolar = 1},
    CC58 = {name = "WaveFormTypeMenu", bipolar = 0},
    CC84 = {name = "FilterDb", bipolar = 0}
  }
  ...
  if cc then
    ...
    local value = controllerValueToWidgetValue(e.value, cc.bipolar)
