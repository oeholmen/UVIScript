...
local knobColour = "#3333" .. getRandom(11,99)
local osc1Colour = colours[getRandom(#colours)]
local osc2Colour = colours[getRandom(#colours)]
local unisonColour = colours[getRandom(#colours)]
local filterColour = colours[getRandom(#colours)]
local lfoColour = colours[getRandom(#colours)]
local filterEnvColour = colours[getRandom(#colours)]
local ampEnvColour = colours[getRandom(#colours)]
local filterEffectsColour = colours[getRandom(#colours)]
local vibratoColour = colours[getRandom(#colours)]
...
filterEnvTargetsPanel.backgroundColour = "#66AA00" .. getRandom(11,99)
...
filterEnvTargets1Panel.backgroundColour = "#66AA00" .. getRandom(11,99)
...
filterEnvTargets2Panel.backgroundColour = "#66AA00" .. getRandom(11,99)
...
lfoPanel.backgroundColour = "#330000" .. getRandom(11,99)
lfoPanel.x = marginX
lfoPanel.y = mixerPanel.y + height + marginY
lfoPanel.width = width
lfoPanel.height = height * 2

lfoTargetPanel.backgroundColour = "#440000" .. getRandom(11,99)
...
lfoTargetPanel1.backgroundColour = "#440000" .. getRandom(11,99)
...
lfoTargetPanel2.backgroundColour = "#440000" .. getRandom(11,99)
...
lfoTargetPanel3.backgroundColour = "#440000" .. getRandom(11,99)
...
function createSequencerPanel()
  ...
  seqPanel.backgroundColour = "#330000" .. getRandom(11,99)
  seqPanel.x = marginX
...
function createTweakPanel()
  ...
  tweakPanel.backgroundColour = "#33AA33" .. getRandom(11,99)
  ...
  tweakButton.textColourOff = "#AAAA" .. getRandom(11,99)
  tweakButton.changed = function(self)
    ...
    for i,v in ipairs(tweakables) do
      if type(v.func) == "function" then
        ...
        v.widget.value = getRandom(v.min, v.max, v.factor)
      end
    end
