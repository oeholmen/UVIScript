--------------------------------------------------------------------------------
-- Random Synth - starts with random values
--------------------------------------------------------------------------------
...
function getRandomBipolar(probability)
  local value = gem.getRandom()
  -- Default probability of neg value is 1/4
  if type(probability) == "nil" then
    probability = 26
  end
  if (gem.getRandom(100) < probability) then
    value = -value
  end
  return value
end
...
function gem.getRandomBoolean(probability)
  ...
  return gem.getRandom(100) <= probability
end

function getRandomMixLevel()
  -- Ensure mix level is not to high or low
  local level = gem.getRandom()
  if level < 0.2 then
    level = 0
...
local colours = {"orange", "yellow", "magenta", "green", "pink", "red", "teal", "blue", "lightblue"}
local knobColour = "#3333" .. gem.getRandom(11,99)
local osc1Colour = colours[gem.getRandom(#colours)]
local osc2Colour = colours[gem.getRandom(#colours)]
local unisonColour = colours[gem.getRandom(#colours)]
local filterColour = colours[gem.getRandom(#colours)]
local lfoColour = colours[gem.getRandom(#colours)]
local filterEnvColour = colours[gem.getRandom(#colours)]
local ampEnvColour = colours[gem.getRandom(#colours)]
local filterEffectsColour = colours[gem.getRandom(#colours)]
local vibratoColour = colours[gem.getRandom(#colours)]
...
function createOsc1Panel()
  ...
  table.insert(tweakables, {widget=osc1ShapeKnob})
  ...
  table.insert(tweakables, {widget=osc1PhaseKnob})
  ...
  table.insert(tweakables, {widget=osc1PitchKnob, min=-2, max=2})
...
function createOsc2Panel()
  ...
  table.insert(tweakables, {widget=osc2ShapeKnob})
  ...
  table.insert(tweakables, {widget=osc2PhaseKnob})
  ...
  table.insert(tweakables, {widget=osc2PitchKnob, min=-24, max=24})
  ...
  table.insert(tweakables, {widget=osc2DetuneKnob}) -- TODO Prefer lower values
...
function createUnisonPanel()
  ...
  table.insert(tweakables, {widget=panSpreadKnob})
  ...
  local unisonDetuneKnob = unisonPanel:Knob("UnisonDetune", 0, 0, 1)
  ...
  table.insert(tweakables, {widget=unisonDetuneKnob}) -- TODO Prefer lower values
  ...
  table.insert(tweakables, {widget=stereoSpreadKnob})
  ...
  table.insert(tweakables, {widget=waveSpreadKnob})
  ...
  table.insert(tweakables, {widget=unisonVoicesKnob,min=8})
...
function createMixerPanel()
  ...
  osc1MixKnob:changed()
  table.insert(tweakables, {widget=osc1MixKnob,func=getRandomMixLevel})
  ...
  osc2MixKnob:changed()
  table.insert(tweakables, {widget=osc2MixKnob,func=getRandomMixLevel})
  ...
  table.insert(tweakables, {widget=noiseMixKnob,func=getRandomMixLevel})
  ...
  table.insert(tweakables, {widget=noiseTypeMenu,min=#noiseTypes})
...
function createFilterPanel()  
  ...
  cutoffKnob:changed()
  table.insert(tweakables, {widget=cutoffKnob})
  ...
  table.insert(tweakables, {widget=filterResonanceKnob})
  ...
  table.insert(tweakables, {widget=filterKeyTrackingKnob})
  ...
  table.insert(tweakables, {widget=wheelToCutoffKnob,func=getRandomBipolar})
  ...
  table.insert(tweakables, {widget=atToCutoffKnob,func=getRandomBipolar})
...
function createHpFilterPanel()
  ...
  table.insert(tweakables, {widget=hpfCutoffKnob})
  ...
  table.insert(tweakables, {widget=hpfResonanceKnob})
  ...
  table.insert(tweakables, {widget=hpfKeyTrackingKnob})
  ...
  table.insert(tweakables, {widget=wheelToHpfCutoffKnob,func=getRandomBipolar})
  ...
  table.insert(tweakables, {widget=atToHpfCutoffKnob,func=getRandomBipolar})
...
function createLfoPanel()
  ...
  table.insert(tweakables, {widget=waveFormTypeMenu,min=#waveFormTypes})
  ...
  table.insert(tweakables, {widget=lfo2SyncButton,func=getRandomBoolean})

  table.insert(tweakables, {widget=lfoFreqKnob,factor=20})
  ...
  table.insert(tweakables, {widget=lfo2TriggerButton,func=getRandomBoolean})
  ...
  table.insert(tweakables, {widget=lfoFreqKeyFollowKnob})
  ...
  table.insert(tweakables, {widget=lfoDelayKnob,factor=5})
  ...
  lfoRiseKnob:changed()
  table.insert(tweakables, {widget=lfoRiseKnob,factor=5})
  ...
  table.insert(tweakables, {widget=lfoSmoothKnob})
  ...
  table.insert(tweakables, {widget=lfoBipolarButton,func=getRandomBoolean,probability=75})
...
function createLfoTargetPanel3()
  ...
  table.insert(tweakables, {widget=lfoToNoiseOverrideButton,func=getRandomBoolean,probability=25})
  table.insert(tweakables, {widget=lfoToNoiseAmpKnob,func=getRandomBipolar})
  table.insert(tweakables, {widget=lfoToNoiseHpfCutoffKnob,func=getRandomBipolar})
  table.insert(tweakables, {widget=lfoToNoiseLpfCutoffKnob,func=getRandomBipolar})
...
function createLfoTargetPanel()
  ...
  table.insert(tweakables, {widget=lfoToDetuneKnob})
  table.insert(tweakables, {widget=lfoToAmpKnob,func=getRandomBipolar})
  table.insert(tweakables, {widget=lfoToHpfCutoffKnob,func=getRandomBipolar})
  table.insert(tweakables, {widget=lfoToCutoffKnob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=lfoToPitchOsc1Knob}) -- TODO Prefer lower values
table.insert(tweakables, {widget=lfoToWaveSpread1Knob,func=getRandomBipolar})
table.insert(tweakables, {widget=osc1LfoToPhaseDistortionKnob})
table.insert(tweakables, {widget=lfoToWT1Knob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=lfoToPitchOsc2Knob}) -- TODO Prefer lower values - 90% = 0, 10% = Random
table.insert(tweakables, {widget=lfoToWaveSpread2Knob,func=getRandomBipolar})
table.insert(tweakables, {widget=osc2LfoToPhaseDistortionKnob})
table.insert(tweakables, {widget=lfoToWT2Knob,func=getRandomBipolar})
...
function createAmpEnvPanel()
  ...
  table.insert(tweakables, {widget=ampAttackKnob}) -- TODO Handle attack env
  ...
  table.insert(tweakables, {widget=ampDecayKnob,factor=3}) -- TODO Higher probability of lower numbers
  ...
  table.insert(tweakables, {widget=ampSustainKnob})
  ...
  table.insert(tweakables, {widget=ampReleaseKnob,factor=5}) -- TODO Higher probability of lower numbers
  ...
  table.insert(tweakables, {widget=ampVelocityKnob,min=40})
...
function createFilterEnvPanel()
  ...
  table.insert(tweakables, {widget=filterAttackKnob}) -- TODO Handle attack env
  ...
  table.insert(tweakables, {widget=filterDecayKnob,factor=3}) -- TODO Higher probability of lower numbers
  ...
  table.insert(tweakables, {widget=filterSustainKnob})
  ...
  table.insert(tweakables, {widget=filterReleaseKnob,factor=5}) -- TODO Higher probability of lower numbers
  ...
  table.insert(tweakables, {widget=filterVelocityKnob,min=40})
...
envAmtKnob:changed()
table.insert(tweakables, {widget=envAmtKnob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=hpfEnvAmtKnob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=filterEnvToWT1Knob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=filterEnvToPitchOsc1Knob}) -- TODO Prefer lower values
...
table.insert(tweakables, {widget=filterEnvToWT2Knob,func=getRandomBipolar})
...
table.insert(tweakables, {widget=filterEnvToPitchOsc2Knob}) -- TODO Prefer lower values
...
function createEffectsPanel()
  ...
  reverbKnob:changed()
  table.insert(tweakables, {widget=reverbKnob})
  ...
  delayKnob:changed()
  table.insert(tweakables, {widget=delayKnob})
  ...
  chorusKnob:changed()
  table.insert(tweakables, {widget=chorusKnob})
  ...
  driveKnob:changed()
  table.insert(tweakables, {widget=driveKnob}) -- TODO Prefer lower values
  ...
  table.insert(tweakables, {widget=maximizerButton,func=getRandomBoolean,probability=10})
...
function createVibratoPanel()
  ...
  vibratoKnob:changed()
  table.insert(tweakables, {widget=vibratoKnob})

  local vibratoRateKnob = vibratoPanel:Knob("VibratoRate", 0, 0, 1)
  ...
  table.insert(tweakables, {widget=vibratoRateKnob})
  ...
  table.insert(tweakables, {widget=vibratoRiseKnob,factor=5})
  ...
  table.insert(tweakables, {widget=wheelToVibratoKnob})
  ...
  table.insert(tweakables, {widget=atToVibratoKnob})
...
local pageEButton = pagePanel:Button("Tweaks")
...
filterEnvTargetsPanel.backgroundColour = "#66AA00" .. gem.getRandom(11,99)
...
filterEnvTargets1Panel.backgroundColour = "#66AA00" .. gem.getRandom(11,99)
...
filterEnvTargets2Panel.backgroundColour = "#66AA00" .. gem.getRandom(11,99)
...
lfoPanel.backgroundColour = "#330000" .. gem.getRandom(11,99)
lfoPanel.x = marginX
lfoPanel.y = mixerPanel.y + height + marginY
lfoPanel.width = width
lfoPanel.height = height * 2

lfoTargetPanel.backgroundColour = "#440000" .. gem.getRandom(11,99)
...
lfoTargetPanel1.backgroundColour = "#440000" .. gem.getRandom(11,99)
...
lfoTargetPanel2.backgroundColour = "#440000" .. gem.getRandom(11,99)
...
lfoTargetPanel3.backgroundColour = "#440000" .. gem.getRandom(11,99)
...
function createSequencerPanel()
  ...
  seqPanel.backgroundColour = "#330000" .. gem.getRandom(11,99)
  seqPanel.x = marginX
...
function createTweakPanel()
  ...
  tweakPanel.backgroundColour = "#33AA33" .. gem.getRandom(11,99)
  ...
  tweakButton.bounds = {10,height,width-20,height*3}
  tweakButton.textColourOff = "#AAAA" .. gem.getRandom(11,99)
  tweakButton.changed = function(self)
    print("Start tweaking!")
    for i,v in ipairs(tweakables) do
      if type(v.func) == "function" then
        v.widget.value = v.func(v.probability)
      else
        v.widget.value = gem.getRandom(v.min, v.max, v.factor)
      end
    end
...
local tweakPanel = createTweakPanel()
